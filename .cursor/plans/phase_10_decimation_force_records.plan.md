...
overview: "Historical Phase 10 spec; implementation lives in e82462a5 + 10b. Closed 2026-04-14 — load cell metrics deferred."
todos:
...
> **Superseded for implementation:** Use [phase_10_decimation_implementation_e82462a5.plan.md](phase_10_decimation_implementation_e82462a5.plan.md) plus [phase_10b_cal_sd_partitions_751257fe.plan.md](phase_10b_cal_sd_partitions_751257fe.plan.md) (binary `.cal`, dual partitions). This file remains a detailed reference for decimation math and gotchas; calibration via `config.txt` is not the production path.

> **Closure (2026-04-14):** Phase 10 exit approved; **load cell not connected** — force validation (tare, known mass) deferred. See [.cursor/plans/phase_10_deferred_hardware_todos.md](phase_10_deferred_hardware_todos.md).
